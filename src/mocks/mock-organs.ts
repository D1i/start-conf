...
export const organDescriptions: Record<OrganType, string> = {
  "Brain": "The central organ of the nervous system, responsible for thought, memory, and control of the body.",
  "Pituitary gland": "An endocrine gland that regulates growth, metabolism, and reproductive functions.",
  "Thyroid gland": "Regulates metabolism through the release of hormones.",
  "Heart": "A muscular organ that pumps blood throughout the body.",
  "Aorta": "The main artery that carries oxygenated blood from the heart to the body.",
  "Vena cava": "Large vein that carries deoxygenated blood back to the heart.",
  "Left lung": "Organ responsible for gas exchange, providing oxygen to the blood.",
  ...
  "Axillary lymph nodes": "Help protect against infection in the arms and chest.",
  "Inguinal lymph nodes": "Filter lymph from the lower limbs and groin.",
  "Subclavian artery": "Supplies blood to the upper limbs and parts of the brain.",
  ...
  "Central nervous system": "Processes information and coordinates body activity.",
